...
/** Behaviour to represent thirst in dinasours */
public class ThirstBehaviour extends Action implements Behaviour {
   ...
   * @return boolean value of water present in the map
   */
   ...
   *
   * @param actor Actor in the game
   * @param map GameMap object in the game
   * @return HashMap of key String and value Integer
   */
