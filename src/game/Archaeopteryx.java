...
public class Archaeopteryx extends Actor {
  ...
  /** When dinasour is starving, this method will increment it's starvation level by one */
  private void Starving() {
    this.starvationLevel += 1;
  }

  /** When dinasour is thirsting, this method will increment it's starvation level by one */
  private void Thirsting() {
    this.thirstLevel += 1;
  }
  /**
   * This method is used to raise the food level of archaepteryx
   *
   * @param x an int amount to be add into the archaepyteryx food level
   */
  ...
  /**
   * Raise food level of archaeopteryx
   *
   * @param x an int amount to be added into the water level
   */
